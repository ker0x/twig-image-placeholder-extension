...
class SvgExtensionTest extends TestCase
{
    ...
    public function testGetSvgPlaceholderWithoutText(): void
    {
        ...
        $this->assertSame('<svg xmlns="http://www.w3.org/2000/svg" width="500" height="250" viewBox="0 0 500 250"><rect fill="#ddd" width="500" height="250"></rect></svg>', $this->extension->getSvgPlaceholder(500, 250, $options));
