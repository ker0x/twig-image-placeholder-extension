...
{
    protected SvgPlaceholderExtension $extension;
    ...
    public function testGetSvgPlaceholder(): void
    {
        self::assertSame('<svg xmlns="http://www.w3.org/2000/svg" width="300" height="150" viewBox="0 0 300 150"><rect fill="#ddd" width="300" height="150"></rect><text fill="rgba(0,0,0,0.5)" font-family="sans-serif" font-size="30" font-weight="bold" dy="10.5" x="50%" y="50%" text-anchor="middle">300x150</text></svg>', $this->extension->getSvgPlaceholder());
    }

    public function testGetSvgPlaceholderWithOptions(): void
    {
        $options = [
            'bgColor' => '#0F1C3F',
            'textColor' => '#7FDBFF',
